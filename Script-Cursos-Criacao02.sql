...
SELECT * FROM CURSOS inner JOIN PROFESSORES ON C.ID_PROFESSORE = P.ID;

-------------------------------

SELECT * FROM CURSOS AS CS1 INNER JOIN CATEGORIAS_CURSOS AS CG2 ON CS1.ID_CATEGORIA = CG2.ID;

SELECT HABILI FROM HABILIDADES INNER JOIN TIPOS_HABILIDADES ON HABILIDADES.ID_TIPO_HAB = TIPO_HABILIDADES.ID;
